...
<div class="archives-page">
  ...
  <div class="archives-header">
    ...
    <div class="filter-container">
      ...
      <button class="filter-pill" data-filter="programming">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <button class="filter-pill" data-filter="system-design">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <button class="filter-pill" data-filter="ai">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <button class="filter-pill" data-filter="opinions">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <button class="filter-pill" data-filter="movies">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
  ...
  <div class="posts-container">
    <ul class="posts-list" id="archives-list">
      {% for post in site.posts %}
        <li class="post-card" data-categories="{{ post.categories | join: ' ' }}">
          <div class="post-date">
    ...
    <p class="no-posts-message" style="display: none;">No posts found in this category.</p>
  </div>
